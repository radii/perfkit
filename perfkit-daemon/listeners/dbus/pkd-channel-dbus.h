...
/* BOOLEAN:INT,POINTER */
extern void dbus_glib_marshal_pkd_channel_BOOLEAN__INT_POINTER (GClosure     *closure,
                                                                GValue       *return_value,
...
void
dbus_glib_marshal_pkd_channel_BOOLEAN__INT_POINTER (GClosure     *closure,
...
static const DBusGMethodInfo dbus_glib_pkd_channel_methods[] = {
  ...
  { (GCallback) pkd_channel_remove_source, dbus_glib_marshal_pkd_channel_BOOLEAN__INT_POINTER, 594 },
};
