...
PkEncoder* pk_encoder_new_for_connection  (PkConnection        *connection);
void       pk_encoder_set_property_async  (PkEncoder           *encoder,
                                           const gchar         *name,
                                           const GValue        *value,
                                           GCancellable        *cancellable,
                                           GAsyncReadyCallback  callback,
                                           gpointer             user_data);
gboolean   pk_encoder_set_property_finish (PkEncoder            *encoder,
                                           GAsyncResult         *result,
                                           GError              **error);
void       pk_encoder_get_property_async  (PkEncoder           *encoder,
                                           const gchar         *name,
                                           GCancellable        *cancellable,
                                           GAsyncReadyCallback  callback,
                                           gpointer             user_data);
gboolean   pk_encoder_get_property_finish (PkEncoder            *encoder,
                                           GAsyncResult         *result,
                                           GValue               *value,
                                           GError              **error);
