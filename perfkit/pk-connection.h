...
struct _PkConnectionClass
{
	...
	gboolean      (*manager_get_channels_finish)        (PkConnection          *connection,
	                                                     ...
	                                                     gsize                 *channels_len,
	                                                     GError               **error);
	void          (*manager_get_hostname_async)         (PkConnection          *connection,
	                                                     GCancellable          *cancellable,
	                                                     GAsyncReadyCallback    callback,
	                                                     gpointer               user_data);
	gboolean      (*manager_get_hostname_finish)        (PkConnection          *connection,
	                                                     GAsyncResult          *result,
	                                                     gchar                **hostname,
	                                                     GError               **error);
	...
	void          (*subscription_get_created_at_async)  (PkConnection          *connection,
	                                                     ...
	                                                     GAsyncReadyCallback    callback,
	                                                     gpointer               user_data);
	gboolean      (*subscription_get_created_at_finish) (PkConnection          *connection,
	                                                     GAsyncResult          *result,
	                                                     GTimeVal              *tv,
	                                                     GError               **error);
