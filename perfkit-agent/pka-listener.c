                                             ...
                                             gpointer               user_data)   /* IN */
{
	...
	call = ManagerAddSubscriptionCall_Create();
	call->buffer_size = buffer_size;
	call->timeout = timeout;
	g_simple_async_result_set_op_res_gpointer(
			result, call, (GDestroyNotify)ManagerAddSubscriptionCall_Free);
	g_simple_async_result_complete(result);
	g_object_unref(result);
	EXIT;
}
...
pka_listener_subscription_add_channel_async (PkaListener           *listener,     /* IN */
                                             ...
                                             gpointer               user_data)    /* IN */
{
	SubscriptionAddChannelCall *call;
	GSimpleAsyncResult *result;
	...
	call = SubscriptionAddChannelCall_Create();
	call->subscription = subscription;
	call->channel = channel;
	call->monitor = monitor;
	g_simple_async_result_set_op_res_gpointer(
			result, call, (GDestroyNotify)SubscriptionAddChannelCall_Free);
	g_simple_async_result_complete(result);
	g_object_unref(result);
	EXIT;
}
                                              ...
                                              GError        **error)    /* OUT */
{
	...
	ENTRY;
	call = GET_RESULT_POINTER(SubscriptionAddChannelCall, result);
	if (!pka_manager_find_subscription(DEFAULT_CONTEXT, call->subscription,
	                                   &subscription, error)) {
		GOTO(failed);
	}
...
pka_listener_subscription_add_source_async (PkaListener           *listener,     /* IN */
                                            ...
                                            gpointer               user_data)    /* IN */
{
	SubscriptionAddSourceCall *call;
	GSimpleAsyncResult *result;
	...
	call = SubscriptionAddSourceCall_Create();
	call->subscription = subscription;
	call->source = source;
	g_simple_async_result_set_op_res_gpointer(
			result, call, (GDestroyNotify)SubscriptionAddSourceCall_Free);
	g_simple_async_result_complete(result);
	g_object_unref(result);
	EXIT;
}
                                             ...
                                             GError        **error)    /* OUT */
{
	...
	ENTRY;
	call = GET_RESULT_POINTER(SubscriptionAddSourceCall, result);
	if (!pka_manager_find_subscription(DEFAULT_CONTEXT, call->subscription,
	                                   &subscription, error)) {
		GOTO(failed);
	}
	...
	ret = pka_subscription_add_source(subscription, DEFAULT_CONTEXT,
	                                  source, error);
	pka_subscription_unref(subscription);
	g_object_unref(source);
  failed:
...
pka_listener_subscription_remove_source_async (PkaListener           *listener,     /* IN */
                                               ...
                                               gpointer               user_data)    /* IN */
{
	SubscriptionRemoveSourceCall *call;
	GSimpleAsyncResult *result;
	...
	call = SubscriptionRemoveSourceCall_Create();
	call->subscription = subscription;
	call->source = source;
	g_simple_async_result_set_op_res_gpointer(
			result, call, (GDestroyNotify)SubscriptionRemoveSourceCall_Free);
	g_simple_async_result_complete(result);
	g_object_unref(result);
	EXIT;
}
                                                ...
                                                GError        **error)    /* OUT */
{
	...
	ENTRY;
	call = GET_RESULT_POINTER(SubscriptionRemoveSourceCall, result);
	if (!pka_manager_find_subscription(DEFAULT_CONTEXT, call->subscription,
	                                   &subscription, error)) {
		GOTO(failed);
	}
	...
	ret = pka_subscription_remove_source(subscription, DEFAULT_CONTEXT,
	                                     source, error);
	g_object_unref(source);
	pka_subscription_unref(subscription);
  failed:
                                        ...
                                        gpointer               user_data)    /* IN */
{
	...
	call = SubscriptionUnmuteCall_Create();
	call->subscription = subscription;
	g_simple_async_result_set_op_res_gpointer(
			result, call, (GDestroyNotify)SubscriptionUnmuteCall_Free);
	g_simple_async_result_complete(result);
	g_object_unref(result);
	EXIT;
}
                                         ...
                                         GError        **error)    /* OUT */
{
	...
	ENTRY;
	call = GET_RESULT_POINTER(SubscriptionUnmuteCall, result);
	if (!pka_manager_find_subscription(DEFAULT_CONTEXT, call->subscription,
	                                   &subscription, error)) {
		GOTO(failed);
	}
